...
Evaluate each of these six dimensions:
...
{
  "label": "<a short label for this dimension's judgment>",
...
{
  "structure": {"label": "clear_three_part_structure", "explanation": "...", "evidence": [{"quote": "...", "note": "..."}]},
